...
| Live screenshots/submission/clean rehearsal | M9 packaging and Build Week release decision | Fast QA produced sanitized active/revoked screenshots only; final release screenshots, submission evidence, and release decision are not produced or claimed |
