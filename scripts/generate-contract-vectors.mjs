...
function buildBundle() {
  ...
  // v2 binds the executor's fixed read-back observation window.  In
  // particular, the nft JSON remaining-TTL integer is an observation made
  // somewhere inside this signed interval, not an assertion that the timer
  // began at dispatcher receipt time.
  const resultPayloadV2 = ({
    suffix,
    capability,
    capabilityVector,
    operation,
    ...
    owned_schema_digest: ownedSchemaDigest,
    started_at: startedAt,
    readback_started_at: readbackStartedAt,
  ...
  const resultsV2 = {
    applied: signedVector(
      ...
      resultPayloadV2({
        ...
        remainingTtlSeconds: 1799,
        startedAt: "2026-07-18T02:00:06.000Z",
        readbackStartedAt: "2026-07-18T02:00:06.030Z",
        readbackCompletedAt: "2026-07-18T02:00:06.045Z",
        completedAt: "2026-07-18T02:00:06.050Z",
        journalSequence: 12,
      }),
      "sentinelflow execution-result-v2",
      executorResultKey,
    ),
    recoveredActive: signedVector(
      "execution-result-recovered-active-v2",
      resultPayloadV2({
        suffix: "411",
        capability: capabilities.add,
        capabilityVector: capabilityVectors.add,
        ...
        remainingTtlSeconds: 1700,
        startedAt: "2026-07-18T02:01:45.000Z",
        readbackStartedAt: "2026-07-18T02:01:45.002Z",
        readbackCompletedAt: "2026-07-18T02:01:45.016Z",
        completedAt: "2026-07-18T02:01:45.020Z",
        journalSequence: 13,
      }),
      "sentinelflow execution-result-v2",
    ...
    revoked: signedVector(
      ...
      resultPayloadV2({
        ...
        remainingTtlSeconds: null,
        startedAt: "2026-07-18T02:10:01.000Z",
        readbackStartedAt: "2026-07-18T02:10:01.020Z",
        readbackCompletedAt: "2026-07-18T02:10:01.035Z",
        completedAt: "2026-07-18T02:10:01.040Z",
        journalSequence: 15,
      }),
      "sentinelflow execution-result-v2",
    ...
    inspectAbsent: signedVector(
      "execution-result-inspect-absent-v2",
      resultPayloadV2({
        suffix: "430",
        capability: capabilities.inspect,
        capabilityVector: capabilityVectors.inspect,
        ...
        remainingTtlSeconds: null,
        startedAt: "2026-07-18T02:20:01.000Z",
        readbackStartedAt: "2026-07-18T02:20:01.002Z",
        readbackCompletedAt: "2026-07-18T02:20:01.008Z",
        completedAt: "2026-07-18T02:20:01.010Z",
        journalSequence: 17,
      }),
      "sentinelflow execution-result-v2",
  ...
  return {
    ...
    vectors: {
      ...
      execution_result_applied_v2: resultsV2.applied,
      execution_result_recovered_active_v2: resultsV2.recoveredActive,
      execution_result_revoked_v2: resultsV2.revoked,
      execution_result_inspect_absent_v2: resultsV2.inspectAbsent,
